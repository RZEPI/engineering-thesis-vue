  ...
  <base-modal title="Table Filter" ref="dialog">
    ...
    <div class="filter-choice">
      <ul class="filter-form">
        <string-filter-input
          v-if="activeTab === 'name'"
          v-for="nameFilter in filter.name"
          :key="nameFilter.value"
          :className="nameFilter.value"
          :filterValue="nameFilter"
          @update-filter="handleNameCheckboxChange"
        ></string-filter-input>
        <numeric-filter-tab
          v-else
          ...
          @update-filter-interval="handleIsOpenChange"
          :key="activeTab"
        ></numeric-filter-tab>
      </ul>
    </div>
    <div class="clear-filter__container">
      <button class="clear-filter__button" @click="handleClearFilter">
        Clear filter
      </button>
    </div>
  </base-modal>
